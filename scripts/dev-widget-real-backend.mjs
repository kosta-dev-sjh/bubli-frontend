...
const API_BASE_URL = stripTrailingSlash(process.env.NEXT_PUBLIC_API_BASE_URL ?? "http://127.0.0.1:8080");
...
VALUES ('77777777-7777-4777-8777-777777777777', '${SEED_USER_ID}', '${SEED_ROOM_ID}', NULL, NULL, NULL, 'Desktop widget backend sync check', date_trunc('day', now()) + interval '12 hours', date_trunc('day', now()) + interval '13 hours', false, 'LOCAL_ONLY', NULL, now(), now())
