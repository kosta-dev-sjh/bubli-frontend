...
const faqItems = [
  {
    answer: "웹은 프로젝트룸, 자료보드, 작업판, 소통 같은 기본 업무 화면입니다. 데스크탑 앱은 같은 작업공간을 열고 버블, 기기 폴더, 빠른 표시, 타이머 복구 같은 데스크탑 기능을 더합니다.",
    icon: AppWindow,
  ...
  {
    answer: "작업공간에서는 소통 탭에서 채팅과 보이스를 사용합니다. 데스크탑 앱에서는 소통 버블이나 전용 창에서 같은 서버 연결과 보이스 연결을 씁니다.",
    icon: MessageCircle,
    ...
    <>
      ...
      <section className="public-faq" aria-label="자주 묻는 질문">
        <GlassPanel className="public-faq__intro">
          ...
          <p>Bubli는 공개 사이트, 작업공간, 데스크탑 앱이 역할을 나눕니다. FAQ는 이 경계가 헷갈리지 않게 잡는 화면입니다.</p>
        </GlassPanel>
