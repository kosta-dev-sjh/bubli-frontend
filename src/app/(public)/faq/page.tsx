...
const faqItems = [
  ...
  {
    answer: "회원 웹 앱에서는 소통 탭에서 채팅과 보이스를 사용합니다. Tauri 앱에서는 메인 탭을 숨기고 소통 버블이나 전용 창에서 같은 API, WebSocket, LiveKit 연결을 씁니다.",
    icon: MessageCircle,
    question: "앱에서는 채팅과 보이스를 어디서 쓰나요?",
  },
  {
    answer: "TODO, 일정, 채팅, 알림, 타이머 원본은 서버에 둡니다. 개인 에이전트 원문, 상세 위젯 사용 이벤트, 로컬 캐시와 복구 대기열은 Tauri SQLite에 둡니다.",
    icon: Database,
