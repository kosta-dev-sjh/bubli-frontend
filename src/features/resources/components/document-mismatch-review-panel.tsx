...
export const defaultMismatchItems: MismatchItem[] = [
  {
    ...
    comparedValues: [
      { documentLabel: "업무 범위 문서", value: "2026.07.15" },
  ...
  },
  {
    ...
    comparedValues: [
      ...
      { documentLabel: "업무 범위 문서", value: "금액만 기재" },
    ],
    fieldLabel: "금액 참고값",
    id: "amount-vat",
  ...
  },
  {
    ...
    comparedValues: [
      ...
      { documentLabel: "업무 범위 문서", value: "최종 검수 1회" },
    ],
    fieldLabel: "검수 기준",
    id: "inspection-rule",
  ...
  },
  {
    ...
    comparedValues: [
      { documentLabel: "업무 범위 문서", value: "비밀 유지 조항 있음" },
        ...
        <div className={styles.titleBlock}>
          ...
          <div>
            ...
            <p className={styles.description}>
              업무 범위 문서, 견적서, 요구사항 문서에서 서로 다른 값과 빠진 조건을 모아 보여줍니다. 결과는 확정 값이 아니라
