...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          "자료 저장소가 기기 안 검증에서 서버 저장소로 이어져도 자료보드와 다운로드 화면은 같은 권한 기준을 사용한다는 정책을 보여줍니다.",
      },
    },
  },
...
export const ServerReadyPolicy: Story = {
  args: {
    ...
    steps: [
      {
        description: "파일 원본은 서버 저장소에 있고, 서버에는 접근 판단에 필요한 자료 정보를 남깁니다.",
        label: "파일 원본",
        status: "ready",
        value: "서버 저장소",
      },
      {
        description: "개인 자료와 프로젝트룸 자료는 각각 올린 사람과 멤버 권한 기준으로 확인합니다.",
        label: "접근 판단",
        status: "ready",
        value: "자료 범위",
      },
...
export const LocalFallbackWithQuotaBlock: Story = {
  args: {
    currentProviderLabel: "기기 안 검증",
    downloadRuleLabel: "권한 확인 전 파일 접근 차단",
    failureReason: "개인 자료함 용량을 넘어 서버 업로드가 보류되었습니다.",
    limitLabel: "1GB 중 1.12GB 사용",
    steps: [
      {
        description: "서버 저장소 전환 전에는 저장 연결부만 바꿔 같은 화면 흐름을 유지합니다.",
        label: "파일 원본",
        status: "checking",
        value: "기기 안",
      },
      ...
      {
        description: "용량 초과 상태라 기기 안 색인은 유지하고 서버 업로드는 차단합니다.",
        label: "용량",
        status: "blocked",
        value: "112%",
      },
