...
const comments = [
  {
    ...
    role: "프로젝트 리더",
    time: "10:24",
    body: "검수 기준 문장이 업무 범위 문서와 요구사항 문서에서 조금 다르게 적혀 있어요. 최종 검수 횟수는 이 자료 기준으로 확인하면 좋겠습니다.",
    status: "확인 필요",
    tagged: ["팀원 B"],
  },
  {
  ...
  },
  {
    ...
    role: "후보 제안",
    time: "10:38",
    body: "확인 질문 후보: 검수 기준은 업무 범위 문서의 표현을 따르는지, 회의록의 검수 횟수를 따르는지 클라이언트에게 확인할 수 있습니다.",
    status: "후보",
    tagged: [],
  },
];
        ...
        <aside className={styles.side} aria-label="댓글 저장과 알림 기준">
          <section className={styles.sideCard}>
            ...
            <div className={styles.resourceBox}>
              <strong>업무범위정리_최종본_v2.1.pdf</strong>
