...
const resourceItems: [ResourceBoardItem, ...ResourceBoardItem[]] = [
  {
    ...
    missingItems: ["중간보고 날짜가 업무 기준 문서 마감일과 맞는지 확인", "보이스 대기방을 프로젝트룸 보이스로 처리할지 확인"],
    relatedDocs: ["업무기준문서_v2.pdf", "작업범위_초안.docx", "견적서_최종.pdf"],
    scope: "room",
    status: "needsReview",
    title: "회의록_0618.md",
  },
  ...
  },
  {
    ...
    body: "마감일, 수정 범위, 저작권 조건이 들어 있는 업무 기준 문서입니다.",
    id: "contract-v2",
    ...
    <section className="resource-board" aria-label="자료보드">
      <div className="resource-board__toolbar">
        ...
        <label style={{ position: "relative" }}>
          ...
          <input className="resource-board__search" placeholder="업무 기준 문서 관련 회의록 찾아줘" style={{ paddingLeft: 38 }} type="search" />
        </label>
      </div>
