...
const scopeCopyKey: Record<ResourceScope, MessageKey> = {
  ...
  personal: "resources.board.badgePersonal",
  room: "resources.board.badgeRoom",
};
  ...
  return (
    <section className="resource-board" aria-label={t("resources.board.aria")}>
      <div className="resource-board__toolbar">
        <div className="resource-board__filters" aria-label={t("resources.board.scopeFilterAria")}>
