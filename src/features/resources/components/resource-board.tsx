...
const resourceItems: [ResourceBoardItem, ...ResourceBoardItem[]] = [
  {
    ...
    missingItems: ["중간보고 날짜가 업무 범위 문서 마감일과 맞는지 확인", "보이스 대기방을 프로젝트룸 보이스로 처리할지 확인"],
    relatedDocs: ["업무범위정리_v2.pdf", "요구사항_정리.docx", "견적서_최종.pdf"],
    scope: "room",
    status: "needsReview",
    title: "회의록_0618.md",
  },
  ...
  {
    agentSummary: "마감일과 수정 범위가 견적서와 다릅니다. 확인 질문 후보를 만들 수 있습니다.",
    body: "마감일, 수정 범위, 저작권 조건이 들어 있는 업무 범위 문서입니다.",
    id: "contract-v2",
    meta: "프로젝트룸 자료 · v2 · 확인 필요 2",
    missingItems: ["견적서의 마감일 07.15와 회의록의 07.20이 다름", "수정 횟수 기준 표현이 문서마다 다름"],
    ...
    <section className="resource-board" aria-label="자료보드">
      <div className="resource-board__toolbar">
        ...
        <label style={{ position: "relative" }}>
          ...
          <input className="resource-board__search" placeholder="업무 범위 문서 관련 회의록 찾아줘" style={{ paddingLeft: 38 }} type="search" />
        </label>
      </div>
