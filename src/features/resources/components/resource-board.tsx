...
const resourceItems: [ResourceBoardItem, ...ResourceBoardItem[]] = [
  {
    ...
    missingItems: ["중간보고 날짜가 업무 기준 문서 납품일과 맞는지 확인", "보이스 대기방을 프로젝트룸 보이스로 처리할지 확인"],
    relatedDocs: ["요구사항정리_v2.pdf", "요구사항_초안.docx", "견적서_최종.pdf"],
    scope: "room",
    status: "needsReview",
    title: "회의록_0618.md",
  },
  ...
  },
  {
    ...
    body: "납품일, 수정 범위, 저작권 조건이 들어 있는 업무 기준 문서입니다.",
    id: "contract-v2",
