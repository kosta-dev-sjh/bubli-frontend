...
const documents: DocumentSource[] = [
  { name: "업무기준서_v2.pdf", status: "needsReview", type: "업무 기준 문서" },
...
const extractedValues: ExtractedValue[] = [
  ...
  { label: "납품일 후보", source: "업무 기준 문서, 견적서", value: "마감일 확인" },
...
const reviewItems: ReviewItem[] = [
  ...
  {
    detail: "견적서에는 2회 수정이 있으나 업무 기준 문서에는 수정 범위가 비어 있습니다.",
    label: "수정 범위 확인",
    source: "업무 기준 문서 · 견적서",
    type: "missing",
  },
    ...
    <section className="contract-review" aria-label="업무 기준 문서 확인 패널">
      <GlassPanel className="contract-review__hero">
        <div>
          ...
          <h2>업무 기준 문서, 견적서, 요구사항의 값 차이와 빠진 조건을 확인합니다</h2>
          <p>
