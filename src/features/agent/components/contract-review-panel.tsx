...
const documents: DocumentSource[] = [
  { name: "작업범위_v2.pdf", status: "needsReview", type: "기준 자료" },
  { name: "견적서_final.pdf", status: "analyzed", type: "견적서" },
  { name: "요구사항_정리.md", status: "analyzed", type: "요구사항" },
];

const extractedValues: ExtractedValue[] = [
  { label: "프로젝트명", source: "기준 자료", value: "서비스 소개 페이지 번역" },
  { label: "납품일 후보", source: "기준 자료, 견적서", value: "2026.07.15" },
...
const reviewItems: ReviewItem[] = [
  {
    detail: "기준 자료에는 7월 15일, 회의록에는 7월 20일로 적혀 있습니다.",
    label: "납품일 값 차이",
    source: "기준 자료 · 회의록",
    type: "difference",
  },
  {
    detail: "견적서에는 2회 수정이 있으나 기준 자료에는 수정 범위가 비어 있습니다.",
    label: "수정 범위 확인",
    source: "기준 자료 · 견적서",
    type: "missing",
  },
...
export function ContractReviewPanel() {
  return (
    <section className="contract-review" aria-label="기준 문서 확인 패널">
      <GlassPanel className="contract-review__hero">
        <div>
          <Chip icon={<Bot size={14} />} selected>
            기준 문서 확인
          </Chip>
          <h2>기준 자료, 견적서, 요구사항의 값 차이와 빠진 조건을 확인합니다</h2>
          <p>
        ...
        <div className="contract-review__job">
          ...
          <ProgressBar label="기준 문서 분석 진행률" value={92} />
        </div>
      </GlassPanel>
