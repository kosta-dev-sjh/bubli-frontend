...
const MAC_FALLBACK_HREF = "/downloads/macos/Bubli-macOS-0.1.2-arm64.dmg";
    ...
    <div className={styles.wrap}>
      ...
      {macGuideOpen ? (
        <ol className={styles.guide}>
          ...
          <li>
            {t("settings.desktop.macGuide4")}
            <code className={styles.command}>{MAC_QUARANTINE_COMMAND}</code>
          </li>
        </ol>
      ) : null}
    </div>
