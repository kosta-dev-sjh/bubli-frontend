...
export const defaultDownloadSurfaces: ProductSurface[] = [
  ...
  {
    description: "로그인 후 작업공간을 데스크탑에서 열고, 버블과 기기 기능을 같은 작업 흐름에 붙입니다.",
    kind: "DESKTOP_APP",
    label: "데스크탑",
    title: "데스크탑 앱",
    tone: "todo",
...
export const defaultDesktopCapabilities: DesktopCapability[] = [
  {
    description: "메인 창은 회원 업무 화면을 열어 브라우저와 같은 흐름을 보여줍니다.",
        ...
        <div className={styles.titleBlock}>
          ...
          <div>
            ...
            <p className={styles.description}>
              공개 사이트는 앱을 내려받는 입구이고, 실제 업무는 로그인 후 작업공간에서 이어집니다. 데스크탑 앱은 같은
