...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          "v14의 공개 사이트, 회원 웹 앱, Tauri 앱 분리 기준을 바탕으로 다운로드 화면에서 데스크탑 앱의 역할과 WebView/버블/로컬 기능 연결을 설명하는 패널입니다.",
      },
    },
  },
...
export const CommunicationFocused: Story = {
  args: {
    ...
    rules: defaultDownloadRules.filter((rule) => ["비회원 분리", "LiveKit 토큰"].includes(rule.label)),
    surfaces: defaultDownloadSurfaces,
    title: "웹과 앱의 소통 연결",
  },
};
