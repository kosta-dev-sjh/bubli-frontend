...
const defaultReviewItems: ReviewItem[] = [
  {
    id: "review-due-date",
    message: "기준 자료 납품일은 7월 15일이고 회의록에는 7월 20일로 적혀 있습니다.",
    sourceLabel: "기준 자료 2쪽, 회의록_0618.md",
    tone: "conflict",
  },
  {
    id: "review-standard",
    message: "검수 기준은 요구사항 문서에만 있고 기준 자료에는 따로 적혀 있지 않습니다.",
    ...
    <GlassPanel className={cn(styles.panel, className)}>
      <header className={styles.header}>
        <div>
          ...
          <p>
            기준 자료, 견적서, 요구사항 문서에서 뽑은 값은 후보입니다. 사용자가 확인한 값만
