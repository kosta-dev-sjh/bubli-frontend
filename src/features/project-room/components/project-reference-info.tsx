...
const checkItems = [
  ["금액/부가세", "견적서와 업무 기준 문서 금액이 다르면 확인 필요 항목으로 표시"],
  ["지급 조건", "검수 완료 후 며칠 이내인지 문서에서 후보 추출"],
  ["결과물", "금액보다 작업 범위와 납품 기준을 함께 확인"],
];
      ...
      <header className={styles.header}>
        ...
        <div className={styles.titleRow}>
          <div className={styles.titleGroup}>
            <h2 className={styles.title}>작업 금액은 작업 기준을 확인하는 참고값입니다</h2>
            <p className={styles.summary}>
              Bubli는 업무 기준 문서와 견적서에서 금액, 지급 조건, 입금 예정일 후보를 뽑아 프로젝트룸 참고 정보로 함께 보여줍니다. 이 값은
