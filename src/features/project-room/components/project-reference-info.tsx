...
const checkItems = [
  ["금액/부가세", "견적서와 업무 문서 금액이 다르면 확인 필요 항목으로 표시"],
...
export function ProjectReferenceInfo() {
  return (
    <GlassPanel className={styles.panel}>
        ...
        <div className={styles.titleRow}>
          <div className={styles.titleGroup}>
            ...
            <p className={styles.summary}>
              Bubli는 업무 문서와 견적서에서 금액, 지급 조건, 입금 예정일 후보를 뽑아 프로젝트룸 참고 정보로 함께 보여줍니다. 이 값은
      ...
      <section className={styles.contentGrid} aria-label="견적 참고 정보 확인 기준">
