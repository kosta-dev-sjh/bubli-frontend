import { Crown, Link2, LockKeyhole, Settings2, ShieldCheck, UserCheck, UserPlus, UsersRound } from "lucide-react";
      ...
      <div className="member-role__grid">
        <GlassPanel className="member-role__list">
          <div className="member-role__list-top">
            <div>
              <h3>역할 목록</h3>
              <p>프로젝트 리더, 멤버, 게스트는 같은 사람이 맡는 상태가 아니라 프로젝트룸 안의 권한입니다.</p>
            </div>
        ...
        <GlassPanel className="member-role__policy">
          ...
          <div>
            ...
            <p>초대는 친구 목록에서 부르거나, 제한된 초대 링크로 게스트 세션을 만들 수 있습니다.</p>
          </div>
          <div>
            <LockKeyhole size={17} strokeWidth={2.1} />
            <p>게스트는 자료보드, WBS/작업판, 일정, 멤버 목록에 접근하지 않습니다.</p>
          </div>
        </GlassPanel>
      </div>
    </section>
