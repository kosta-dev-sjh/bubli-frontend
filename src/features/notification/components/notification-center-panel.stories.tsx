...
const meta = {
  args: {
    ...
    initialNotifications: [
      ...
      {
        body: "{success=true, code=OK, message=AI 작업 agent-job-analyze-resource이 완료되었습니다., data={summary=계약서에서 납품일과 수정 범위 확인 항목을 찾았습니다., items=[2회 무상 수정, 납품일 7월 18일]}}",
        createdAt: "2026-07-04T00:50:00.000Z",
        id: "story-notification-resource",
        readAt: null,
        sourceId: "agent-job-analyze-resource-88",
        sourceType: "AGENT",
        status: "UNREAD",
        title: ", message=AI 작업 agent-job-analyze-resource이 완료되었습니다.",
      },
    ],
  },
