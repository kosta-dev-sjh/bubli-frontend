...
const connectionRows = [
  ["메인 앱 화면", "작업공간", "프로젝트룸, 자료보드, 작업판을 같은 화면으로 봅니다."],
...
export function HybridAppFrame() {
  return (
    <GlassPanel className={styles.panel}>
      <header className={styles.header}>
        ...
        <div className={styles.titleRow}>
          <div className={styles.titleGroup}>
            <h2 className={styles.title}>같은 작업공간에 데스크톱 기능만 얹습니다</h2>
            <p className={styles.summary}>
              데스크탑 앱은 별도 서비스를 새로 만드는 방식이 아닙니다. 회원 업무 화면을 열고, 앱에서만 필요한 버블,
      ...
      <section className={styles.layout} aria-label="작업공간과 데스크탑 앱 구조">
        <div className={styles.window}>
          <div className={styles.windowBar}>
            <span />
            <span />
            <span />
            <strong>Bubli 데스크탑 앱 · 작업공간</strong>
          </div>
          <div className={styles.windowBody}>
            ...
            <main className={styles.webApp}>
              <div className={styles.webHeader}>
                ...
                <StatusBadge tone="room">작업공간</StatusBadge>
              </div>
