...
const frames = [
  ...
  {
    body: "로그인한 업무 화면을 데스크탑에서도 열고, 위젯과 기기 기능을 더합니다.",
    icon: MonitorDown,
    title: "데스크탑 앱",
  },
];
        ...
        {frames.map((frame) => {
          ...
          return (
            <GlassPanel className="hybrid-frame__card" key={frame.title}>
              ...
              <h3>{frame.title}</h3>
              <p>{frame.body}</p>
              <div className="hybrid-frame__diagram" aria-hidden="true">
                <span className="hybrid-frame__diagram-line" style={{ width: "72%" }} />
                <span className="hybrid-frame__diagram-line" style={{ width: "92%" }} />
                <span className="hybrid-frame__diagram-line" style={{ width: "58%" }} />
              </div>
            </GlassPanel>
          );
        })}
