  ...
  args: {
    items: [
      ...
      },
      {
        ...
        note: "상세 사용 이벤트는 로컬에 남기고, 서버에는 항목 상태와 날짜별 집계만 저장합니다.",
        ownerLabel: "사용자 기준",
        status: "limited",
        storageLabel: "서버 DB와 Tauri SQLite",
        tone: "widget",
      },
      {
        allowed: "Tauri 앱은 사용자가 지정한 폴더와 로컬 캐시, 개인 에이전트 원문을 기기 안에서 다룹니다.",
        blocked: "전체 PC 파일, 화면 내용, 키보드 입력은 수집 대상이 아닙니다.",
        dataName: "Tauri 로컬 데이터",
        note: "로컬 SQLite가 손상되면 로컬 백업으로 복구하고, 서버 원본 데이터는 API로 다시 내려받습니다.",
        ownerLabel: "기기 기준",
        status: "limited",
