            ...
            >
              ...
              <div className="grid gap-3 md:grid-cols-2">
                <div className="rounded-[var(--radius-input)] border border-[var(--glass-border)] bg-[rgba(255,255,255,0.58)] p-3">
                  <div className="mb-2 flex items-center gap-2 text-sm font-[820] text-[var(--color-blue-deep)]">
                ...
                <div className="rounded-[var(--radius-input)] border border-[var(--glass-border)] bg-[rgba(255,255,255,0.58)] p-3">
                  <div className="mb-2 flex items-center gap-2 text-sm font-[820] text-[var(--color-muted)]">
