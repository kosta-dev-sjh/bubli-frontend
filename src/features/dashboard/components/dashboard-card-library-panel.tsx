...
const statusMeta: Record<CardStatus, { actionLabelKey: MessageKey; labelKey: MessageKey; tone: StatusTone }> = {
  ADDED: { actionLabelKey: "dashboard.library.status.addedAction", labelKey: "dashboard.library.status.addedLabel", tone: "approved" },
  AVAILABLE: { actionLabelKey: "dashboard.library.status.availableAction", labelKey: "dashboard.library.status.availableLabel", tone: "pending" },
  DISABLED: { actionLabelKey: "dashboard.library.status.disabledAction", labelKey: "dashboard.library.status.disabledLabel", tone: "personal" },
};
...
export function DashboardCardLibraryPanel({
  ...
  const panelTitle = title ?? t("dashboard.library.title");
