...
const ko = {
  ...
  // 폴더 해제 시 "서버 자료도 함께 삭제"를 골랐지만 폴더 경로를 알 수 없는 경우.
  "local.folder.cleanupPathMissing": "폴더 경로가 비어 있어 이 폴더의 서버 자료를 정리할 수 없습니다.",
...
const en: Record<Key, string> = {
  ...
  "local.folder.cleanupPathMissing": "The folder path is empty, so this folder's server files cannot be cleaned up.",
...
const ja: Record<Key, string> = {
  ...
  "local.folder.cleanupPathMissing": "フォルダのパスが空のため、このフォルダのサーバー資料を整理できません。",
